...
Figure~\ref{fig:svd} (in the accompanying notebook) shows that the
cumulative explained variance curve does not reach 90\% within 1,000
...
Figure~\ref{fig:pr} (in the accompanying notebook) shows the
precision--recall curve for the best LR model.
