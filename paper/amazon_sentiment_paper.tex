...
\begin{table}[H]
  ...
  \begin{tabular}{lccccc}
    ...
    \best{+ Balanced + ElasticNet + Threshold ($\tau^*\!=\!0.37$)} & \best{0.901} & \best{0.821} & \best{0.750} & \best{0.784} & \best{0.951} \\
    \bottomrule
  \end{tabular}}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccccc}
    ...
    \best{LR + Balanced + EN + Threshold ($\tau^*\!=\!0.37$)} & \best{0.901}  & 0.821          & \best{0.750}   & \best{0.784}   & 0.951 \\
